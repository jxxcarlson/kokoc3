...
{
	if (region.b8.aU === region.cw.aU)
	{
		return 'on line ' + region.b8.aU;
	}
	return 'on lines ' + region.b8.aU + ' through ' + region.cw.aU;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d0: 'hidden', aL: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d0: 'mozHidden', aL: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d0: 'msHidden', aL: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d0: 'webkitHidden', aL: 'webkitvisibilitychange' }
		: { d0: 'hidden', aL: 'visibilitychange' };
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.bc)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	elm$core$Maybe$isJust(request.a5) && (xhr.timeout = request.a5.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		bc: xhr.responseURL,
		eE: { dN: xhr.status, j: xhr.statusText },
																		...
																		return function (lastViewed) {
																			return function (created) {
																				return function (modified) {
																					return {cf: access, bH: archive, bf: authorId, dv: authorIdentifier, bI: authorName, bL: children, w: content, cs: created, bo: docType, W: id, bU: identifier, cK: lastViewed, ax: level, cM: modified, bv: parentId, b2: parentTitle, b4: _public, ca: tags, bB: textType, J: title, cd: version};
																				};
																			};
																		};
																	};
...
var author$project$Document$newDocumentText = 'Replace this sentence by some really great prose ...';
...
var author$project$Document$basicDocument = author$project$Document$Document(0)('basicDocument123')(0)('author123')('Phineas Phud')('Welcome to kNode Reader')(author$project$Document$newDocumentText)(1)(true)(elm$core$Dict$empty)(
	_List_fromArray(
...
var author$project$DocumentList$empty = {G: _List_Nil, aD: elm$core$Maybe$Nothing};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cA: fragment, cE: host, cT: path, cV: port_, cZ: protocol, c_: query};
	});
...
var author$project$Main$sendInfoOutside = function (info) {
	if (!info.$) {
		...
		return author$project$Main$infoForOutside(
			{ar: value, aF: 'DocumentData'});
	} else {
		var value = info.a;
		return author$project$Main$infoForOutside(
			{ar: elm$json$Json$Encode$null, aF: 'AskToReconnectDocument'});
	}
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var jinjor$elm_debounce$Debounce$Debounce = elm$core$Basics$identity;
var jinjor$elm_debounce$Debounce$init = {M: _List_Nil, aV: false};
	...
	return _Utils_Tuple2(
		{
			...
			e: _Utils_update(
				...
				{J: 'Welcome!'}),
			U: false,
			as: jinjor$elm_debounce$Debounce$init,
			aN: 0,
			D: 0,
			aP: '',
			V: author$project$DocumentDictionary$empty,
			m: author$project$DocumentList$empty,
			at: '',
...
var elm$time$Time$State = F2(
	function (taggers, processes) {
		return {cY: processes, db: taggers};
	});
...
var elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _n0 = A2(elm$core$Dict$get, interval, state.db);
		if (_n0.$ === 1) {
...
var author$project$Main$autosaveSubscription = function (model) {
	return model.U ? A2(elm$time$Time$every, model.bJ, author$project$Main$SaveCurrentDocument) : elm$core$Platform$Sub$none;
};
...
var author$project$Document$Child = F5(
	function (title, docId, docIdentifier, level, comment) {
		return {bM: comment, bP: docId, bQ: docIdentifier, ax: level, J: title};
	});
...
var author$project$Main$DocumentDataFromOutside = elm$core$Basics$identity;
	...
	function (tagger, onError) {
		return author$project$Main$infoForElm(
			function (outsideInfo) {
				var _n0 = outsideInfo.aF;
				if (_n0 === 'ReconnectDocument') {
					var _n1 = A2(elm$json$Json$Decode$decodeValue, author$project$Document$decodeDocumentFromOutside, outsideInfo.ar);
					if (!_n1.$) {
						var result = _n1.a;
						return tagger(result);
					} else {
						var e = _n1.a;
						return onError('Bad decode (getInfoFromOutside)');
					}
				} else {
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'text_type',
				author$project$Document$encodeTextType(doc.bB)),
				_Utils_Tuple2(
				'public',
				elm$json$Json$Encode$bool(doc.b4)),
				_Utils_Tuple2(
				'doc_type',
				author$project$Document$encodeDocType(doc.bo)),
				_Utils_Tuple2(
				'level',
				elm$json$Json$Encode$int(doc.ax)),
				_Utils_Tuple2(
				'archive',
				elm$json$Json$Encode$string(doc.bH)),
				_Utils_Tuple2(
				'version',
				elm$json$Json$Encode$int(doc.cd))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(document.W)),
				_Utils_Tuple2(
				'identifier',
				elm$json$Json$Encode$string(document.bU)),
				_Utils_Tuple2(
				'author_id',
				elm$json$Json$Encode$int(document.bf)),
				_Utils_Tuple2(
				'author_name',
				elm$json$Json$Encode$string(document.bI)),
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(document.J)),
				_Utils_Tuple2(
				'content',
				elm$json$Json$Encode$string(document.w)),
				_Utils_Tuple2(
				'tags',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, document.ca)),
				_Utils_Tuple2(
				'parent_id',
				elm$json$Json$Encode$int(document.bv)),
				_Utils_Tuple2(
				'parent_title',
				elm$json$Json$Encode$string(document.b2)),
				_Utils_Tuple2(
				'attributes',
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response.aK);
			if (_n0.$ === 1) {
		...
		return elm$http$Http$request(
			{
				...
				aQ: elm$http$Http$expectJson(author$project$Document$documentRecordDecoder),
				aR: _List_fromArray(
					[
				...
				aW: 'Put',
				a5: elm$core$Maybe$Just(5000),
				bc: author$project$Configuration$backend + ('/api/documents/' + (elm$core$String$fromInt(document.W) + ('?' + queryString))),
				bd: false
			});
	});
...
var author$project$Document$attachDocumentToMasterBelowCmd_ = F4(
	function (tokenString, selectedDocId_, childDocument, masterDocument) {
		var query = 'attach=below&child=' + (elm$core$String$fromInt(childDocument.W) + ('&current=' + elm$core$String$fromInt(selectedDocId_)));
		var masterDocumentId = childDocument.bv;
		var _n0 = _Utils_eq(masterDocumentId, masterDocument.W);
		if (!_n0) {
		...
		return elm$http$Http$request(
			{
				aK: elm$http$Http$jsonBody(
					author$project$Document$encodeDocumentRecord(document)),
				aQ: elm$http$Http$expectJson(author$project$Document$replyDecoder),
				aR: _List_fromArray(
					[
						A2(elm$http$Http$header, 'APIVersion', 'V2'),
						A2(elm$http$Http$header, 'Authorization', 'Bearer ' + tokenString)
				...
				aW: 'Delete',
				a5: elm$core$Maybe$Just(5000),
				bc: author$project$Configuration$backend + ('/api/documents/' + elm$core$String$fromInt(document.W)),
				bd: false
			});
	});
...
var author$project$Document$getDocumentByIdRequest = F2(
	function (id, maybeTokenString) {
		...
		return elm$http$Http$request(
			{
				aK: elm$http$Http$jsonBody(elm$json$Json$Encode$null),
				aQ: elm$http$Http$expectJson(author$project$Document$documentRecordDecoder),
				aR: headers,
				aW: 'Get',
				a5: elm$core$Maybe$Just(5000),
				bc: _Utils_ap(author$project$Configuration$backend, route),
				bd: false
			});
	});
								...
								A2(
									...
									elm$core$List$head(
										A2(
											elm$core$List$drop,
											1,
											A2(elm$core$String$split, ',', document.w)))))))))));
};
	...
	function (targetDocId, documentList) {
		...
		if (_n0) {
			...
			var maybeTargetIndex = A2(
				...
				function (doc) {
					return _Utils_eq(doc.W, targetDocId);
				},
...
var author$project$DocumentList$documentListLength = function (_n0) {
	var documentList = _n0;
	return elm$core$List$length(documentList.G);
};
...
var author$project$DocumentList$DocumentListRecord = F2(
	function (documents, selected) {
		return {G: documents, aD: selected};
	});
...
var author$project$DocumentList$findDocumentsRequest = F2(
	function (maybeUser, queryString) {
		...
		return elm$http$Http$request(
			{
				aK: elm$http$Http$jsonBody(elm$json$Json$Encode$null),
				aQ: elm$http$Http$expectJson(author$project$DocumentList$documentListDecoder),
				aR: headers,
				aW: 'Get',
				a5: elm$core$Maybe$Just(5000),
				bc: _Utils_ap(author$project$Configuration$backend, route),
...
var author$project$DocumentList$prepend = F2(
	function (document, _n0) {
		...
		return _Utils_update(
			documentListRecord,
			{
				G: A2(elm$core$List$cons, document, documentListRecord.G),
				aD: elm$core$Maybe$Just(document)
			});
	});
var author$project$DocumentList$select = F2(
	function (maybeSelectedDocument, _n0) {
		var documentList = _n0;
		return {G: documentList.G, aD: maybeSelectedDocument};
	});
...
var author$project$Main$debounceConfig = {
	eF: jinjor$elm_debounce$Debounce$later(250),
		...
		return elm$http$Http$request(
			{
				...
				aW: 'Post',
				a5: elm$core$Maybe$Just(5000),
				bc: author$project$Configuration$backend + '/api/documents/',
				bd: false
			});
	});
...
var author$project$Main$makeNewDocumentWithParent = F4(
	function (parentId, parentTitle, selectedDocumentId, user) {
		...
		return _Utils_update(
			newDocument_,
			{
				bf: author$project$User$userId(user),
				bI: author$project$User$username(user),
				w: 'New Child Document of ' + (parentTitle + (', placeUnder:' + elm$core$String$fromInt(selectedDocumentId))),
				bv: parentId,
				b2: parentTitle,
				J: 'New Child Document'
			});
	});
	...
	function (user, model) {
		var selectedDocumentId = function () {
			...
			if (_n2.$ === 1) {
				...
				return selectedDoc.W;
			}
		}();
		var headDocument = author$project$DocumentList$getFirst(model.m);
		var parentId = function () {
			var _n1 = headDocument.bo;
			if (_n1 === 1) {
				return headDocument.W;
			} else {
				return 0;
			}
		}();
		var parentTitle = function () {
			var _n0 = headDocument.bo;
			if (_n0 === 1) {
				return headDocument.J;
			} else {
				return '';
			}
		}();
...
var author$project$DocumentList$make = F2(
	function (document, listOfDocuments) {
		var documentListRecord = {
			G: A2(elm$core$List$cons, document, listOfDocuments),
			aD: elm$core$Maybe$Just(document)
		};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(child.J)),
				_Utils_Tuple2(
				'level',
				elm$json$Json$Encode$int(child.ax)),
				_Utils_Tuple2(
				'docIdentifier',
				elm$json$Json$Encode$string(child.bQ)),
				_Utils_Tuple2(
				'docId',
				elm$json$Json$Encode$int(child.bP)),
				_Utils_Tuple2(
				'comment',
				elm$json$Json$Encode$string(child.bM))
			]));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'level',
				elm$json$Json$Encode$int(document.ax)),
				_Utils_Tuple2(
				'public',
				elm$json$Json$Encode$bool(document.b4)),
				_Utils_Tuple2(
				'access',
				A3(elm$json$Json$Encode$dict, elm$core$Basics$identity, elm$json$Json$Encode$string, document.cf)),
				_Utils_Tuple2(
				'tags',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, document.ca)),
				_Utils_Tuple2(
				'children',
				A2(elm$json$Json$Encode$list, author$project$Document$encodeChildForOutside, document.bL)),
				_Utils_Tuple2(
				'parentId',
				elm$json$Json$Encode$int(document.bv)),
				_Utils_Tuple2(
				...
				_Utils_Tuple2(
				'textType',
				author$project$Document$encodeTextType(document.bB)),
				_Utils_Tuple2(
				'docType',
				author$project$Document$encodeDocType(document.bo)),
				_Utils_Tuple2(
				'archive',
				elm$json$Json$Encode$string(document.bH)),
				_Utils_Tuple2(
				'version',
				elm$json$Json$Encode$int(document.cd)),
				_Utils_Tuple2(
				'lastViewed',
				elm$json$Json$Encode$int(
					elm$time$Time$posixToMillis(document.cK))),
				_Utils_Tuple2(
				'created',
				elm$json$Json$Encode$int(
					elm$time$Time$posixToMillis(document.cs))),
				_Utils_Tuple2(
				'lastModified',
				elm$json$Json$Encode$int(
					elm$time$Time$posixToMillis(document.cM)))
			]));
};
...
var author$project$Main$saveDocToLocalStorage = function (document) {
	var value = author$project$Document$encodeDocumentForOutside(document);
	return author$project$Main$sendInfoOutside(
		author$project$Main$DocumentData(value));
};
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {d5: index, ee: match, ei: number, eI: submatches};
	});
		...
		return elm$http$Http$request(
			{
				...
				aQ: elm$http$Http$expectJson(author$project$User$tokenDecoder),
				aR: _List_Nil,
				aW: 'Post',
				a5: elm$core$Maybe$Just(5000),
				bc: author$project$Configuration$backend + '/api/authentication/',
				bd: false
			});
	});
...
var author$project$User$testUser = {dV: 'jxxcarlson@gmail.com', W: 1, cb: 'fake', cc: 'jxxcarlson'};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 5:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: elm$core$String$toLower(
								elm$core$String$reverse(model.j))
						}),
					elm$core$Platform$Cmd$none);
			case 12:
				var result = msg.a;
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								o: A2(
									author$project$User$maybeSetToken,
									token,
									elm$core$Maybe$Just(author$project$User$testUser)),
								az: elm$core$Maybe$Just(token),
								j: 'token OK'
							}),
						elm$core$Platform$Cmd$none);
				} else {
			...
			case 13:
				switch (msg.a.$) {
					case 0:
						...
						if (!result.$) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{e: documentRecord.dT, j: 'document OK'}),
								elm$core$Platform$Cmd$none);
						} else {
							var err = result.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										j: author$project$Main$handleHttpError(err)
									}),
								elm$core$Platform$Cmd$none);
						}
					case 3:
						...
						if (!result.$) {
							...
							var indexOfDocumentToDelete = A2(
								...
								A2(
									elm_community$list_extra$List$Extra$findIndex,
									function (doc) {
										return _Utils_eq(doc.W, idOfDocumentToDelete);
									},
									documents));
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										...
										j: 'Document deleted: ' + (elm$core$String$fromInt(indexOfDocumentToDelete) + (', Document selected: ' + elm$core$String$fromInt(documentSelectedId))),
										A: 1
									}),
								elm$core$Platform$Cmd$none);
						} else {
					...
					case 1:
						...
						if (!result.$) {
							var documentRecord = result.a;
							var nextDocument = documentRecord.dT;
							...
							var cmd = A2(
								...
								A4(
									...
									author$project$User$getTokenStringFromMaybeUser(model.o),
									selectedDocId_,
									nextDocument,
									model.ay));
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										e: nextDocument,
										m: nextDocumentList_,
										j: 'selectedDocId = ' + elm$core$String$fromInt(selectedDocId_)
									}),
								cmd);
						} else {
							var err = result.a;
				...
				if (!msg.a.$) {
					...
					if (!result.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									e: author$project$DocumentList$getFirst(documentList),
									m: author$project$DocumentList$selectFirst(documentList),
									ay: nextMaybeMasterDocument,
									j: 'documentList: ' + elm$core$String$fromInt(
							...
							A2(
								...
								A4(
									...
									author$project$User$readToken(model.az),
									currentDocument,
									currentDocument.ca,
									model.V)));
					} else {
					...
					if (!result.$) {
						...
						var nextDocumentList_ = A2(
							author$project$DocumentList$select,
							elm$core$Maybe$Just(model.e),
							documentList);
						var currentDocument = author$project$DocumentList$getFirst(documentList);
						var nextMaybeMasterDocument = function () {
							var _n13 = currentDocument.bo;
							if (!_n13) {
								return elm$core$Maybe$Nothing;
							} else {
								return elm$core$Maybe$Just(currentDocument);
				...
				var loadMasterCommand = function () {
					...
					if (!_n14) {
						...
						return A2(
							...
							A2(author$project$DocumentList$loadMasterDocument, model.o, document.W));
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
				...
				if (!msg.a.$) {
					...
					return _Utils_Tuple2(
						...
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$DocListMsg,
							A2(author$project$DocumentList$loadMasterDocument, model.o, docId)));
				} else {
					var docId = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
						...
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$DocListMsg,
							A2(author$project$DocumentList$loadMasterDocumentWithCurrentSelection, model.o, docId)));
				}
			case 6:
				return _Utils_Tuple2(
					model,
					A2(
						...
						A2(author$project$User$getToken, 'jxxcarlson@gmail.com', model.a1)));
			case 7:
				var id = msg.a;
				return _Utils_Tuple2(
					model,
			...
			case 11:
				var idString = msg.a;
				var _n16 = elm$core$String$toInt(idString);
				if (_n16.$ === 1) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var id = _n16.a;
					return _Utils_Tuple2(
						...
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$DocListMsg,
							A2(author$project$DocumentList$loadMasterDocument, model.o, id)));
				}
			case 17:
				var result = msg.a;
				if (!result.$) {
					var documentRecord = result.a;
					var doc = documentRecord.dT;
					var dict = model.V;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								V: A3(author$project$DocumentDictionary$put, 'texmacros', doc, dict),
								j: 'Put texmacros: ' + elm$core$String$fromInt(doc.W)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
				...
				if (_n18.$ === 1) {
					...
					return _Utils_Tuple2(
						...
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$DocListMsg,
							A2(author$project$DocumentList$findDocuments, model.o, queryString)));
				}
			case 20:
			...
			case 21:
				var msg_ = msg.a;
				var tokenString = author$project$User$getTokenStringFromMaybeUser(model.o);
				var _n19 = A4(
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{as: debounce, aN: model.aN + 1}),
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								cmd,
								author$project$Main$saveDocToLocalStorage(model.e)
							])));
			case 22:
				var str = msg.a;
				var _n20 = A3(jinjor$elm_debounce$Debounce$push, author$project$Main$debounceConfig, str, model.as);
				var debounce = _n20.a;
				var cmd = _n20.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{U: true, as: debounce, b7: str}),
					cmd);
			case 23:
				var str = msg.a;
				var currentDocument = model.e;
			...
			case 24:
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							U: false,
							j: 'Saved document: ' + elm$core$String$fromInt(model.e.W)
						}),
					A2(
						elm$core$Platform$Cmd$map,
						author$project$Main$DocMsg,
						A2(author$project$Document$saveDocument, tokenString, model.e)));
			case 25:
				var tokenString = author$project$User$getTokenStringFromMaybeUser(model.o);
				var tags = A2(
					elm$core$List$map,
					elm$core$String$trim,
					A2(elm$core$String$split, ',', model.bz));
				var currentDocument = model.e;
				var nextCurrentDocument = _Utils_update(
					currentDocument,
					{ca: tags, J: model.at});
			...
			case 28:
				...
				var nextModel = function () {
					if (nextToolPanelState === 1) {
						return _Utils_update(
							model,
							{A: nextToolPanelState});
					} else {
						return _Utils_update(
							model,
							{D: 0, at: model.e.J, A: nextToolPanelState});
					}
				}();
			...
			case 33:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bZ: elm$core$Maybe$Just(viewport)
						}),
					elm$core$Platform$Cmd$none);
			case 34:
				var tokenString = author$project$User$getTokenStringFromMaybeUser(model.o);
				...
				if (!_n23) {
					...
					return _Utils_Tuple2(
						...
						A2(
							elm$core$Platform$Cmd$map,
							author$project$Main$DocMsg,
							A2(author$project$Document$deleteDocument, tokenString, model.e)));
				}
			case 35:
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$NewChildDocument = {$: 30};
	...
	return elm$core$String$concat(
		_List_fromArray(
			[
				...
				mdgriffith$stylish_elephants$Internal$Model$formatColorClass(shadow.S)
			]));
};
...
var mdgriffith$stylish_elephants$Internal$Model$unwrapDecorations = function (attrs) {
		...
		function (x, styles) {
			if (x.$ === 12) {
				...
				return _Utils_update(
					styles,
					{
						eH: A2(elm$core$List$cons, x, styles.eH)
					});
			}
		});
	...
	return addShadow(
		A3(
			elm$core$List$foldr,
			joinShadows,
			{a3: elm$core$Maybe$Nothing, eH: _List_Nil},
			A2(
				elm$core$List$filterMap,
...
var mdgriffith$stylish_elephants$Internal$Style$classes = {di: 'a', dj: 'atv', dl: 'ab', dm: 'cx', dn: 'cy', $7: 'acb', dp: 'accx', dq: 'accy', dr: 'acr', ch: 'al', ci: 'ar', ds: 'at', bF: 'ah', bG: 'av', dt: 's', dx: 'bh', dy: 'b', dz: 'w7', dB: 'bd', dC: 'bdt', bg: 'bn', dD: 'bs', bh: 'cpe', dK: 'cp', dL: 'cpx', dM: 'cpy', T: 'c', bk: 'cr', bl: 'cb', aM: 'ccx', aq: 'ccy', cr: 'cl', bm: 'cr', dO: 'ct', dQ: 'cptr', dR: 'ctxt', dZ: 'fcs', d_: 'g', aS: 'hc', cC: 'hf', d$: 'hfp', d1: 'hv', d4: 'fr', d7: 'iml', d8: 'it', ea: 'i', eh: 'notxt', ej: 'ol', el: 'or', ai: 'oq', bu: 'oh', cR: 'pg', cS: 'p', ep: 'ppe', es: 'se', c3: 'r', eu: 'sb', ev: 'sbx', ew: 'sby', ex: 'sb', eA: 'e', eC: 'se', eG: 'sk', a4: 't', eK: 'tc', eL: 'w8', eM: 'w2', eN: 'w9', eO: 'tj', bA: 'tja', eP: 'tl', eQ: 'w3', eR: 'w5', eS: 'w4', eT: 'tr', eU: 'w6', eV: 'w1', eW: 'tun', e$: 'ts', am: 'clr', e0: 'u', de: 'wc', e4: 'we', df: 'wf', e5: 'wfp'};
var mdgriffith$stylish_elephants$Element$mouseDown = function (decs) {
	return A2(
		...
		A2(
			...
			A2(
				elm$core$List$map,
				mdgriffith$stylish_elephants$Internal$Model$tag(mdgriffith$stylish_elephants$Internal$Style$classes.dj),
...
var mdgriffith$stylish_elephants$Element$pointer = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$cursor, mdgriffith$stylish_elephants$Internal$Style$classes.dQ);
...
var mdgriffith$stylish_elephants$Internal$Model$defaultOptions = {dZ: mdgriffith$stylish_elephants$Internal$Model$focusDefaultStyle, d1: 1, ef: 1};
	...
	switch (style.$) {
		...
		case 7:
			...
			return 'grid-rows-' + (A2(
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$stylish_elephants$Internal$Model$lengthClassName, template.et)) + ('-cols-' + (A2(
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$stylish_elephants$Internal$Model$lengthClassName, template.C)) + ('-space-x-' + (mdgriffith$stylish_elephants$Internal$Model$lengthClassName(template.eD.a) + ('-space-y-' + mdgriffith$stylish_elephants$Internal$Model$lengthClassName(template.eD.b)))))));
		case 8:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.c3) + ('-' + (elm$core$String$fromInt(pos.cq) + ('-' + (elm$core$String$fromInt(pos.ce) + ('-' + elm$core$String$fromInt(pos.bT)))))));
		case 10:
...
var mdgriffith$stylish_elephants$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + (':focus .focusable, ' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + '.focusable:focus')),
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			_List_fromArray(
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										mdgriffith$stylish_elephants$Internal$Model$vDomClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.eA))
									]),
								styles)
							]));
			}
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.bk, mdgriffith$stylish_elephants$Internal$Style$classes.aq, mdgriffith$stylish_elephants$Internal$Style$classes.dr])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.bk, mdgriffith$stylish_elephants$Internal$Style$classes.aq, mdgriffith$stylish_elephants$Internal$Style$classes.dp])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.bk, mdgriffith$stylish_elephants$Internal$Style$classes.dq])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.bk, mdgriffith$stylish_elephants$Internal$Style$classes.$7])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var mdgriffith$stylish_elephants$Internal$Style$contentName = function (desc) {
	switch (desc) {
		case 0:
			var _n1 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dO);
		case 1:
			var _n2 = desc;
		...
		case 3:
			var _n4 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.cr);
		case 4:
			var _n5 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.aM);
		default:
			var _n6 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.aq);
	}
};
var mdgriffith$stylish_elephants$Internal$Style$selfName = function (desc) {
	switch (desc) {
		case 0:
			var _n1 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.ds);
		case 1:
			var _n2 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dl);
		case 2:
			var _n3 = desc;
			return mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.ci);
		case 3:
			var _n4 = desc;
...
var mdgriffith$stylish_elephants$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.c3) + (' > ' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + (' { flex-basis: auto !important; } ' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.c3) + (' > ' + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + (mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.bk) + ' { flex-basis: auto !important; }}'))))))))));
...
var mdgriffith$stylish_elephants$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bj: closing, v: _List_Nil, Z: _List_Nil, O: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								v: A2(
									elm$core$List$cons,
									{bj: '\n}', v: _List_Nil, Z: props, O: '@supports (' + (prop + (':' + (value + (') {' + parent.O))))},
									rendered.v)
							});
					case 4:
						var selector = rule.a;
							...
							rendered,
							{
								v: A2(
									...
									A2(
										...
										A2(mdgriffith$stylish_elephants$Internal$Style$emptyIntermediate, parent.O + (' + ' + selector), ''),
										adjRules),
									rendered.v)
							});
					case 1:
						...
						return _Utils_update(
							rendered,
							{
								v: A2(
									...
									A2(
										mdgriffith$stylish_elephants$Internal$Style$renderRules,
										A2(mdgriffith$stylish_elephants$Internal$Style$emptyIntermediate, parent.O + (' > ' + child), ''),
										childRules),
									rendered.v)
							});
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								v: A2(
									...
									A2(
										mdgriffith$stylish_elephants$Internal$Style$renderRules,
										A2(mdgriffith$stylish_elephants$Internal$Style$emptyIntermediate, parent.O, ''),
										batched),
									rendered.v)
							});
				}
...
var mdgriffith$stylish_elephants$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.O + ('{' + (renderValues(rule.Z) + (rule.bj + '}')));
		}
	};
	...
	mdgriffith$stylish_elephants$Internal$Style$renderCompact(
		_List_fromArray(
			[
				...
				A2(
				mdgriffith$stylish_elephants$Internal$Style$Class,
				mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt) + ':focus',
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.bh),
						_List_fromArray(
							[
						...
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.d1, mdgriffith$stylish_elephants$Internal$Style$classes.am)) + ':hover',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '0')
							])),
						...
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.d1, mdgriffith$stylish_elephants$Internal$Style$classes.ai)) + ':hover',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '1')
							])),
						...
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.dZ, mdgriffith$stylish_elephants$Internal$Style$classes.am)) + ':focus',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '0')
							])),
						...
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.dZ, mdgriffith$stylish_elephants$Internal$Style$classes.ai)) + ':focus',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '1')
							])),
						...
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.dj, mdgriffith$stylish_elephants$Internal$Style$classes.am)) + ':active',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '0')
							])),
						...
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(
							_Utils_ap(mdgriffith$stylish_elephants$Internal$Style$classes.dj, mdgriffith$stylish_elephants$Internal$Style$classes.ai)) + ':active',
						_List_fromArray(
							[
								A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'opacity', '1')
							])),
						...
						_List_fromArray(
							[
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								'u:first-of-type.' + mdgriffith$stylish_elephants$Internal$Style$classes.dr,
								_List_fromArray(
									[
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								's:first-of-type.' + mdgriffith$stylish_elephants$Internal$Style$classes.dp,
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '1'),
										A2(
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								's:last-of-type.' + mdgriffith$stylish_elephants$Internal$Style$classes.dp,
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '1'),
										A2(
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								's:only-of-type.' + mdgriffith$stylish_elephants$Internal$Style$classes.dp,
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '1'),
										A2(
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								's:last-of-type.' + (mdgriffith$stylish_elephants$Internal$Style$classes.dp + ' ~ u'),
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '0')
									])),
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								'u:first-of-type.' + (mdgriffith$stylish_elephants$Internal$Style$classes.dr + (' ~ s.' + mdgriffith$stylish_elephants$Internal$Style$classes.dp)),
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '0')
									])),
						...
						_List_fromArray(
							[
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								'u:first-of-type.' + mdgriffith$stylish_elephants$Internal$Style$classes.$7,
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '1')
									])),
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								'u:first-of-type.' + (mdgriffith$stylish_elephants$Internal$Style$classes.$7 + (' ~ s.' + mdgriffith$stylish_elephants$Internal$Style$classes.dq)),
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'flex-grow', '0')
									])),
						...
						_List_fromArray(
							[
								...
								A2(
								mdgriffith$stylish_elephants$Internal$Style$Child,
								mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.dt + ':first-child'),
								_List_fromArray(
									[
								...
								mdgriffith$stylish_elephants$Internal$Style$Child,
								mdgriffith$stylish_elephants$Internal$Style$dot(
									mdgriffith$stylish_elephants$Internal$Style$classes.dt + (mdgriffith$stylish_elephants$Internal$Style$selfName(3) + (':first-child + .' + mdgriffith$stylish_elephants$Internal$Style$classes.dt))),
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'margin', '0 !important')
									])),
								...
								mdgriffith$stylish_elephants$Internal$Style$Child,
								mdgriffith$stylish_elephants$Internal$Style$dot(
									mdgriffith$stylish_elephants$Internal$Style$classes.dt + (mdgriffith$stylish_elephants$Internal$Style$selfName(2) + (':first-child + .' + mdgriffith$stylish_elephants$Internal$Style$classes.dt))),
								_List_fromArray(
									[
										A2(mdgriffith$stylish_elephants$Internal$Style$Prop, 'margin', '0 !important')
									])),
						...
						A2(
						mdgriffith$stylish_elephants$Internal$Style$Descriptor,
						mdgriffith$stylish_elephants$Internal$Style$dot(mdgriffith$stylish_elephants$Internal$Style$classes.d7),
						_List_fromArray(
							[
			...
			[
				...
				elm$json$Json$Encode$string(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.a4, mdgriffith$stylish_elephants$Internal$Style$classes.de, mdgriffith$stylish_elephants$Internal$Style$classes.aS]))))
			]),
		_List_fromArray(
			[
			...
			[
				...
				elm$json$Json$Encode$string(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.a4, mdgriffith$stylish_elephants$Internal$Style$classes.df, mdgriffith$stylish_elephants$Internal$Style$classes.cC]))))
			]),
		_List_fromArray(
			[
				elm$virtual_dom$VirtualDom$text(str)
				...
				switch (rule.$) {
					...
					case 8:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									'-ms-grid-row: ' + (elm$core$String$fromInt(position.c3) + ';'),
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.c3) + (' / ' + (elm$core$String$fromInt(position.c3 + position.bT) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.cq) + (' / ' + (elm$core$String$fromInt(position.cq + position.ce) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.c3) + ('-' + (elm$core$String$fromInt(position.cq) + ('-' + (elm$core$String$fromInt(position.ce) + ('-' + elm$core$String$fromInt(position.bT)))))));
					...
					rendered,
					{
						...
						a9: function () {
							...
							if (_n15.$ === 1) {
								...
								var topLevel = _n15.a;
								return _Utils_ap(rendered.a9, topLevel);
							}
						}()
					});
			});
	...
	function (embedMode, children, context, rendered) {
					...
					case 1:
						...
						return _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.d2, elm$core$Maybe$Nothing, context)),
								htmls),
							_Utils_ap(styled.eH, existingStyles));
					case 2:
						var str = child.a;
			...
			if (children.$ === 1) {
				...
				return A2(
					...
					A3(
						elm$core$List$foldr,
						gatherKeyed,
						_Utils_Tuple2(_List_Nil, rendered.eH),
						keyedChildren));
			} else {
			...
			if (!embedMode.$) {
				...
				return A3(
					...
					_Utils_Tuple2(
						...
						_List_fromArray(
							[
								mdgriffith$stylish_elephants$Internal$Model$renderFocusStyle(options.dZ)
							])),
					styleChildren).b;
			}
		}();
		...
		if (!embedMode.$) {
			if (!styleChildren.b) {
				...
				return mdgriffith$stylish_elephants$Internal$Model$Styled(
					{
						d2: A2(mdgriffith$stylish_elephants$Internal$Model$renderNode, rendered, renderedChildren),
						eH: styleChildren
					});
			}
		} else {
...
var mdgriffith$stylish_elephants$Internal$Model$contextClasses = function (context) {
	switch (context) {
		case 0:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.c3));
		case 1:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.T));
		case 2:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.eA));
		case 3:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.d_));
		case 4:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.cS));
		default:
			return mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dt + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.cR));
	}
};
...
var mdgriffith$stylish_elephants$Internal$Model$finalize = function (gathered) {
	...
	var _n0 = addTransform(
		addTextShadows(
			addBoxShadows(
				_Utils_Tuple2(_List_Nil, gathered.eH))));
...
var mdgriffith$stylish_elephants$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bF + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.ch);
		case 2:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bF + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.ci);
		default:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bF + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.dm);
	}
};
var mdgriffith$stylish_elephants$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bG + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.ds);
		case 2:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bG + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.dl);
		default:
			return mdgriffith$stylish_elephants$Internal$Style$classes.bG + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.dn);
	}
};
				...
				case 1:
					return _Utils_update(
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(mdgriffith$stylish_elephants$Internal$Style$classes.aS),
								gathered.a),
					...
					return (portion === 1) ? _Utils_update(
						...
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(
									mdgriffith$stylish_elephants$Internal$Style$classes.d$ + (' height-fill-' + elm$core$String$fromInt(portion))),
								gathered.a),
							d: A2(mdgriffith$stylish_elephants$Internal$Flag$add, mdgriffith$stylish_elephants$Internal$Flag$heightFill, gathered.d),
							eH: A2(
								elm$core$List$cons,
								A3(
									mdgriffith$stylish_elephants$Internal$Model$Single,
									'.' + (mdgriffith$stylish_elephants$Internal$Style$classes.dt + ('.' + (mdgriffith$stylish_elephants$Internal$Style$classes.T + (' > ' + mdgriffith$stylish_elephants$Internal$Style$dot(
				...
				case 3:
					...
					var newGathered = _Utils_update(
						gathered,
						{
							...
							eH: A2(elm$core$List$cons, style, gathered.eH)
						});
					var $temp$h = len,
					...
					return _Utils_update(
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(
									mdgriffith$stylish_elephants$Internal$Style$classes.e4 + (' width-px-' + elm$core$String$fromInt(px))),
								gathered.a),
							eH: A2(
								elm$core$List$cons,
								A3(
				...
				case 1:
					return _Utils_update(
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(mdgriffith$stylish_elephants$Internal$Style$classes.de),
								gathered.a),
				...
				case 2:
					...
					return (portion === 1) ? _Utils_update(
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(mdgriffith$stylish_elephants$Internal$Style$classes.df),
								gathered.a),
						...
						gathered,
						{
							a: A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$classNameAttr(
									mdgriffith$stylish_elephants$Internal$Style$classes.e5 + (' width-fill-' + elm$core$String$fromInt(portion))),
								gathered.a),
							d: A2(mdgriffith$stylish_elephants$Internal$Flag$add, mdgriffith$stylish_elephants$Internal$Flag$widthFill, gathered.d),
							eH: A2(
								elm$core$List$cons,
								A3(
									mdgriffith$stylish_elephants$Internal$Model$Single,
									'.' + (mdgriffith$stylish_elephants$Internal$Style$classes.dt + ('.' + (mdgriffith$stylish_elephants$Internal$Style$classes.c3 + (' > ' + mdgriffith$stylish_elephants$Internal$Style$dot(
...
var mdgriffith$stylish_elephants$Internal$Model$emptyTransformGroup = {aB: elm$core$Maybe$Nothing, aC: elm$core$Maybe$Nothing, al: elm$core$Maybe$Nothing};
var mdgriffith$stylish_elephants$Internal$Model$emptyTransformationStates = {dj: elm$core$Maybe$Nothing, dZ: elm$core$Maybe$Nothing, d1: elm$core$Maybe$Nothing, aX: elm$core$Maybe$Nothing};
...
var mdgriffith$stylish_elephants$Internal$Model$stackOn = F3(
	function (maybePseudo, transform, gathered) {
		var states = A2(elm$core$Maybe$withDefault, mdgriffith$stylish_elephants$Internal$Model$emptyTransformationStates, gathered.e_);
		if (maybePseudo.$ === 1) {
			var normal = states.aX;
			return _Utils_update(
				gathered,
				{
									...
									if (styleProp.$ === 10) {
										return A2(
											...
											A2(
												elm$virtual_dom$VirtualDom$property,
												'className',
												elm$json$Json$Encode$string(mdgriffith$stylish_elephants$Internal$Style$classes.e$)),
											A2(
												elm$core$List$cons,
												mdgriffith$stylish_elephants$Internal$Model$classNameAttr(
				...
				switch (description.$) {
					case 0:
						return _Utils_update(
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'main', gathered.r)
							});
					case 1:
						return _Utils_update(
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'nav', gathered.r)
							});
					case 2:
						return _Utils_update(
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'footer', gathered.r)
							});
					case 3:
						return _Utils_update(
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'aside', gathered.r)
							});
					case 4:
						var i = description.a;
						return (i <= 1) ? _Utils_update(
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'h1', gathered.r)
							}) : ((i < 7) ? _Utils_update(
							gathered,
							{
								r: A2(
							...
							gathered,
							{
								r: A2(mdgriffith$stylish_elephants$Internal$Model$addNodeName, 'h6', gathered.r)
							}));
					case 8:
						return _Utils_update(
							gathered,
				...
				var styles = function () {
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return elm$core$Maybe$Just(
								_Utils_ap(gathered.eH, styled.eH));
					}
				}();
								...
								switch (location) {
									case 0:
										return A2(
											...
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.di]));
									case 1:
										return A2(
											elm$core$String$join,
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.dy]));
									case 2:
										return A2(
											elm$core$String$join,
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.el]));
									case 3:
										return A2(
											elm$core$String$join,
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.ej]));
									case 4:
										return A2(
											elm$core$String$join,
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.d4]));
									default:
										return A2(
											elm$core$String$join,
											' ',
											_List_fromArray(
												[mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.dx]));
								}
							}())
						]),
					_List_fromArray(
						[
							...
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return A2(styled.d2, elm$core$Maybe$Nothing, mdgriffith$stylish_elephants$Internal$Model$asEl);
							}
						}()
						]));
				return _Utils_update(
					gathered,
					{
						bL: A2(elm$core$List$cons, nearbyElement, gathered.bL),
						eH: function () {
							if (styles.$ === 1) {
								return gathered.eH;
							} else {
		...
		return A5(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.aM),
						A2(
							elm$core$List$cons,
							mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.aq),
							A2(
								elm$core$List$cons,
								mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.ex),
								A2(
									elm$core$List$cons,
...
var author$project$Main$newChildButton__ = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('New subdocument'),
			ek: elm$core$Maybe$Just(author$project$Main$NewChildDocument)
		});
};
...
var author$project$Main$NewDocument = {$: 29};
var author$project$Main$newDocumentButton_ = function (model) {
	return A2(
		mdgriffith$stylish_elephants$Element$Input$button,
		author$project$Widget$buttonStyle(
			mdgriffith$stylish_elephants$Element$px(110)),
		{
			eb: mdgriffith$stylish_elephants$Element$text('New document'),
			ek: elm$core$Maybe$Just(author$project$Main$NewDocument)
		});
};
var author$project$Main$newDocumentButton = function (model) {
	...
	if (!_n0) {
		...
		return author$project$Main$newDocumentButton_(model);
	}
};
var author$project$Main$ToggleToolPanelState = {$: 28};
...
var author$project$Main$toggleToolsButton_ = F2(
	function (width_, model) {
		return A2(
			mdgriffith$stylish_elephants$Element$Input$button,
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text(
					author$project$Main$toggleToolsTitle(model.A)),
				ek: elm$core$Maybe$Just(author$project$Main$ToggleToolPanelState)
			});
	});
var author$project$Main$toggleToolsButton = F2(
	function (width_, model) {
		var _n0 = model.u;
		if (_n0 === 1) {
			return A2(author$project$Main$toggleToolsButton_, width_, model);
		} else {
			return mdgriffith$stylish_elephants$Element$none;
		}
	});
...
var mdgriffith$stylish_elephants$Element$Font$extraBold = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontWeight, mdgriffith$stylish_elephants$Internal$Style$classes.eL);
var mdgriffith$stylish_elephants$Element$Font$regular = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontWeight, mdgriffith$stylish_elephants$Internal$Style$classes.eS);
var author$project$DocumentListView$selectedElementStyle = F2(
	function (maybeSelectedDocument, document) {
		if (maybeSelectedDocument.$ === 1) {
			...
			return _Utils_eq(selectedDocument.W, document.W) ? _List_fromArray(
				[
...
var mdgriffith$stylish_elephants$Element$clipX = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$overflow, mdgriffith$stylish_elephants$Internal$Style$classes.dL);
			...
			A2(
					...
					mdgriffith$stylish_elephants$Element$px(190)),
				{
					eb: A2(
						...
						mdgriffith$stylish_elephants$Element$text(document.J)),
					ek: elm$core$Maybe$Just(document)
				}));
	});
...
var mdgriffith$stylish_elephants$Element$column = F2(
	function (attrs, children) {
		return A5(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.dO),
				A2(
					elm$core$List$cons,
					mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.cr),
					A2(
						elm$core$List$cons,
...
var mdgriffith$stylish_elephants$Element$scrollbarY = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$overflow, mdgriffith$stylish_elephants$Internal$Style$classes.ew);
...
var mdgriffith$stylish_elephants$Element$Font$bold = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontWeight, mdgriffith$stylish_elephants$Internal$Style$classes.dz);
...
var author$project$Main$CancelDeleteCurrentDocument = {$: 35};
var author$project$Main$cancelDeleteCurrentDocumentButton_ = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Cancel'),
				ek: elm$core$Maybe$Just(author$project$Main$CancelDeleteCurrentDocument)
			});
	});
...
var author$project$Main$DeleteCurrentDocument = {$: 34};
	...
	function (width_, model) {
		return A2(
			...
			A2(
				...
				width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Delete'),
				ek: elm$core$Maybe$Just(author$project$Main$DeleteCurrentDocument)
			});
	});
var author$project$Main$SetDocumentType = function (a) {
	return {$: 32, a: a};
};
var mdgriffith$stylish_elephants$Element$Font$light = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$fontWeight, mdgriffith$stylish_elephants$Internal$Style$classes.eQ);
	...
	function (model, docType) {
		return _Utils_ap(
			author$project$Widget$listItemStyleNarrow(
				mdgriffith$stylish_elephants$Element$px(110)),
			A2(author$project$Main$highLightDocumentType, model.e.bo, docType));
	});
var author$project$Main$masterDocumentButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Master'),
...
var author$project$Main$standardDocumentButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Standard'),
			ek: elm$core$Maybe$Just(
...
var author$project$Main$textTypeButtonStyle = F2(
	function (model, textType) {
		return _Utils_ap(
			author$project$Widget$listItemStyleNarrow(
				mdgriffith$stylish_elephants$Element$px(110)),
			A2(author$project$Main$highLightTextType, model.e.bB, textType));
	});
var author$project$Main$asciidocLatexTypeButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Asciidoc Latex'),
			ek: elm$core$Maybe$Just(
...
var author$project$Main$asciidocTypeButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Asciidoc'),
			ek: elm$core$Maybe$Just(
...
var author$project$Main$markdownTypeButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Markdown'),
			ek: elm$core$Maybe$Just(
...
var author$project$Main$miniLatexTypeButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('MiniLatex'),
			ek: elm$core$Maybe$Just(
...
var author$project$Main$plainTextTypeButton = function (model) {
	return A2(
		...
		{
			eb: mdgriffith$stylish_elephants$Element$text('Plain Text'),
			ek: elm$core$Maybe$Just(
...
var mdgriffith$stylish_elephants$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
			...
			if (!_n1.$) {
				...
				return _Utils_Tuple3(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$stylish_elephants$Element$Input$value(textOptions.a4),
								mdgriffith$stylish_elephants$Internal$Model$Attr(
								elm$html$Html$Attributes$type_(inputType)),
								mdgriffith$stylish_elephants$Element$Input$spellcheck(textInput.E),
								mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.d8),
								function () {
								var _n2 = textInput.B;
								if (_n2.$ === 1) {
									return mdgriffith$stylish_elephants$Internal$Model$NoAttribute;
				...
				var _n3 = A3(
										...
										if (_n5.$ === 1) {
											if (val.$ === 1) {
												return _Utils_update(
													found,
													{
														F: A2(elm$core$List$cons, attr, found.F),
														aS: elm$core$Maybe$Just(val)
													});
											} else {
												return _Utils_update(
													found,
					...
					{F: _List_Nil, aS: elm$core$Maybe$Nothing, bq: elm$core$Maybe$Nothing, br: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.bq;
				var heightContent = _n3.aS;
				var maybeSpacing = _n3.br;
				var adjustedAttributes = _n3.F;
				...
				return _Utils_Tuple3(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$stylish_elephants$Element$Input$spellcheck(textInput.E),
								mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.d7),
								A2(
								elm$core$Maybe$withDefault,
								...
								if (maybePadding.$ === 1) {
									...
									return mdgriffith$stylish_elephants$Element$paddingEach(
										{
											dE: A2(elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											ed: l,
											er: r,
											eX: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
									...
									if (heightContent.a.$ === 1) {
										...
										var newlineCount = function (x) {
											...
											elm$core$List$length(
												elm$core$String$lines(textOptions.a4)));
					...
					_List_fromArray(
						[
							...
							elm$html$Html$text(textOptions.a4))
						]));
			}
		}();
		var inputNode = _n0.a;
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$stylish_elephants$Internal$Model$htmlClass(mdgriffith$stylish_elephants$Internal$Style$classes.eh + (' ' + mdgriffith$stylish_elephants$Internal$Style$classes.ep)),
																...
																(elm$core$String$trim(textOptions.a4) !== '') ? 0 : 1)
															]),
														placeholderAttrs))),
											placeholderEl))
									]);
		...
		return A3(
			...
			A2(
				elm$core$List$cons,
				A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$cursor, mdgriffith$stylish_elephants$Internal$Style$classes.dR),
				A2(
					elm$core$List$cons,
					mdgriffith$stylish_elephants$Element$spacing(5),
...
var mdgriffith$stylish_elephants$Element$Input$text = mdgriffith$stylish_elephants$Element$Input$textHelper(
	{
		...
		E: false,
		K: mdgriffith$stylish_elephants$Element$Input$TextInputNode('text')
	});
		...
		_List_fromArray(
			[
				...
				mdgriffith$stylish_elephants$Element$text(
					'Master doc: ' + elm$core$String$fromInt(model.e.bv)))
			]));
};
...
var mdgriffith$stylish_elephants$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{B: elm$core$Maybe$Nothing, E: multi.c8, K: mdgriffith$stylish_elephants$Element$Input$TextArea},
			attrs,
			{eb: multi.eb, aY: multi.aY, a2: multi.a2, a4: multi.a4});
	});
					...
					A2(
							...
							]),
						{
							eb: A2(
								...
								mdgriffith$stylish_elephants$Element$text('')),
							aY: elm$core$Maybe$Just(author$project$Main$AcceptDocumentTagString),
							a2: elm$core$Maybe$Nothing,
							c8: false,
							a4: A2(elm$core$String$join, ', ', model.e.ca)
						}))
				]));
	});
...
var author$project$Main$UpdateCurrentDocument = {$: 25};
var author$project$Main$updateDocumentButton = function (model) {
	return A2(
		mdgriffith$stylish_elephants$Element$Input$button,
		author$project$Widget$buttonStyle(
			mdgriffith$stylish_elephants$Element$px(130)),
		{
			eb: mdgriffith$stylish_elephants$Element$text('Update document'),
			ek: elm$core$Maybe$Just(author$project$Main$UpdateCurrentDocument)
		});
};
var author$project$Main$newVersionUrl = function (document) {
	return author$project$Configuration$backend + ('/archive/new_version' + ('/' + elm$core$String$fromInt(document.W)));
};
...
var author$project$Widget$linkButton = F3(
	function (url, label_, width_) {
		return A2(
			...
			{
				eb: mdgriffith$stylish_elephants$Element$text(label_),
				bc: url
			});
	});
var author$project$Main$newVersionButton = function (model) {
	return A3(
		...
		author$project$Main$newVersionUrl(model.e),
		'New version',
		mdgriffith$stylish_elephants$Element$px(100));
};
var author$project$Main$showVersionsUrl = function (document) {
	return author$project$Configuration$backend + ('/archive/versions' + ('/' + elm$core$String$fromInt(document.W)));
};
var author$project$Main$showVersionButton = function (model) {
	return A3(
		author$project$Widget$linkButton,
		author$project$Main$showVersionsUrl(model.e),
		'Show versions',
		mdgriffith$stylish_elephants$Element$px(100));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(
					'Version: ' + elm$core$String$fromInt(model.e.cd))),
				A2(
				mdgriffith$stylish_elephants$Element$column,
				_List_Nil,
				_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Main$updateDocumentButton(model),
						A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							mdgriffith$stylish_elephants$Element$px(80),
							model),
...
var author$project$Document$asciidocText = function (str) {
	return A3(
		elm$html$Html$node,
		'asciidoc-text',
		_List_fromArray(
...
var author$project$Document$viewAsciidoc = F2(
		...
		return A2(
			...
			_Utils_Tuple2(
				...
				mdgriffith$stylish_elephants$Element$html(
					author$project$Document$asciidocText(str))));
	});
		...
		if (!asts.b) {
			return _List_fromArray(
				[
					_List_fromArray(
					[
						pablohirafuji$elm_markdown$Markdown$Block$BlankLine(match.ee)
					])
				]);
		} else {
			var ast = asts.a;
	...
	if (((_n0.b && _n0.b.b) && (!_n0.b.a.$)) && _n0.b.b.b) {
		...
		return elm$core$Maybe$Just(
			A2(
				...
				true,
				{
					bR: A2(elm$core$String$left, 1, fence),
					bS: elm$core$String$length(fence),
					t: A2(
						elm$core$Maybe$withDefault,
						0,
			...
			_Utils_Tuple3(
				{
					...
					t: elm$core$String$length(indentString) + 1,
					X: false,
					K: pablohirafuji$elm_markdown$Markdown$Block$Unordered
				},
				A2(elm$core$Maybe$withDefault, '', maybeIndentSpace),
				A2(elm$core$Maybe$withDefault, '', maybeRawLine)));
	} else {
			...
			if (ast.b) {
				switch (ast.a.$) {
					case 6:
						...
						var items = _n2.b;
						var astTail = ast.b;
						return _Utils_eq(listBlock.aO, model.aO) ? function (a) {
							return A2(elm$core$List$cons, a, astTail);
						}(
							A2(
								pablohirafuji$elm_markdown$Markdown$Block$List,
								_Utils_update(
									...
									{
										t: listBlock.t,
										X: model.X || pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items)
									}),
...
var pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions = {cj: pablohirafuji$elm_markdown$Markdown$Config$defaultAllowedHtmlAttributes, ck: pablohirafuji$elm_markdown$Markdown$Config$defaultAllowedHtmlElements};
var pablohirafuji$elm_markdown$Markdown$Config$defaultOptions = {
	c$: pablohirafuji$elm_markdown$Markdown$Config$Sanitize(pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions),
	eB: false
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$initParser = F3(
	function (options, refs, rawText) {
		return {f: _List_Nil, a_: options, y: rawText, b5: refs, l: _List_Nil};
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$matchToInline = function (_n0) {
	...
	switch (_n1.$) {
		case 0:
			return pablohirafuji$elm_markdown$Markdown$Inline$Text(match.a4);
		case 1:
			return pablohirafuji$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return pablohirafuji$elm_markdown$Markdown$Inline$CodeInline(match.a4);
		case 3:
			var _n2 = _n1.a;
			var text = _n2.a;
			var url = _n2.b;
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{cw: childMatch.cw - parentMatch.I, b8: childMatch.b8 - parentMatch.I, aG: childMatch.aG - parentMatch.I, I: childMatch.I - parentMatch.I});
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_n0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.cw, match.b8) < 1) ? A2(elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.b8, match.b8) < 0) && (_Utils_cmp(prevMatch.cw, match.cw) > 0)) ? A2(
				elm$core$List$cons,
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		f: _List_Nil,
		b8: 0,
		a4: pablohirafuji$elm_markdown$Markdown$Helpers$formatStr(text),
		aG: 0,
		I: 0,
		K: pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _n2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				f: A3(pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.a4, _List_Nil, matchModel.f)
			});
		if (!parsedMatches.b) {
			var finalStr = A2(elm$core$String$dropLeft, matchModel.cw, rawText);
			...
			return _Utils_eq(matchHead.K, pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2(elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.cw, matchHead.b8) ? A2(elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.cw, matchHead.b8) < 0) ? A2(
				elm$core$List$cons,
				updtMatch,
				A2(
					elm$core$List$cons,
					pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3(elm$core$String$slice, matchModel.cw, matchHead.b8, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.b8 > 0) ? A2(
						elm$core$List$cons,
						pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
							A2(elm$core$String$left, matchModel.b8, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_n0.b && _n0.b.b) && (!_n0.b.a.$)) {
		...
		return pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? elm$core$Maybe$Just(
			{
				d5: regMatch.d5 + backslashesLength,
				g: 1,
				i: pablohirafuji$elm_markdown$Markdown$InlineParser$CharToken('<')
			}) : elm$core$Maybe$Nothing;
	} else {
		return elm$core$Maybe$Nothing;
	}
		...
		return elm$core$Maybe$Just(
			{
				d5: regMatch.d5 + backslashesLength,
				g: 1,
				i: pablohirafuji$elm_markdown$Markdown$InlineParser$RightAngleBracket(
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToEmphasisToken = F3(
	function (_char, rawText, regMatch) {
		...
		if ((((_n0.b && _n0.b.b) && _n0.b.b.b) && (!_n0.b.b.a.$)) && _n0.b.b.b.b) {
			...
			var mLeftFringe = (regMatch.d5 && (!leftFringeLength)) ? elm$core$Maybe$Just(
				A3(elm$core$String$slice, regMatch.d5 - 1, regMatch.d5, rawText)) : maybeLeftFringe;
			var backslashesLength = A2(
				elm$core$Maybe$withDefault,
				0,
				A2(elm$core$Maybe$map, elm$core$String$length, maybeBackslashes));
			...
			var index = ((regMatch.d5 + backslashesLength) + leftFringeLength) + (isEscaped ? 1 : 0);
			return ((delimiterLength <= 0) || ((_char === '_') && _Utils_eq(
				...
				_Utils_Tuple2(2, 2)))) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(
				{
					d5: index,
					g: delimiterLength,
					i: A2(pablohirafuji$elm_markdown$Markdown$InlineParser$EmphasisToken, _char, fringeRank)
				});
		} else {
			return elm$core$Maybe$Nothing;
		}
		...
		return elm$core$Maybe$Just(
			{
				...
				i: pablohirafuji$elm_markdown$Markdown$InlineParser$CodeToken(
					!pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength))
			});
	} else {
		return elm$core$Maybe$Nothing;
	...
	while (true) {
		if (_n0.b) {
			if (!_n0.a.$) {
				...
				return (!pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? elm$core$Maybe$Just(
					{d5: (regMatch.d5 + backslashesLength) - 1, g: 2, i: pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : elm$core$Maybe$Nothing;
			} else {
				if (_n0.b.b && (!_n0.b.a.$)) {
					var _n1 = _n0.b;
					return elm$core$Maybe$Just(
						{
							d5: regMatch.d5,
							g: elm$core$String$length(regMatch.ee),
							i: pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken
						});
				} else {
					break _n0$2;
				}
	...
	while (true) {
		if (_n0.b) {
			if (!_n0.a.$) {
				...
				var backslashesLength = elm$core$String$length(backslashes);
				return pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? elm$core$Maybe$Just(
					{d5: regMatch.d5 + backslashesLength, g: 1, i: pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : elm$core$Maybe$Just(
					{d5: (regMatch.d5 + backslashesLength) - 1, g: 2, i: pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_n0.b.b) {
					var _n1 = _n0.b;
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_n0.b && _n0.b.b) && _n0.b.b.b) && (!_n0.b.b.a.$)) {
		...
		var index = (regMatch.d5 + backslashesLength) + ((isEscaped && _Utils_eq(
			maybeImageOpen,
			...
			l: A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.a_.eB, model.y),
							_Utils_ap(
	...
	A2(
		...
		function (match) {
			return A2(
				elm$core$Maybe$withDefault,
				match.ee,
				elm$url$Url$percentDecode(match.ee));
		}));
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_n0) {
	var match = _n0;
	return A2(elm$regex$Regex$contains, pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.a4) ? elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				K: pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.a4,
						pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.a4)))
		...
		if ((((_n0.b && _n0.b.b) && _n0.b.b.b) && _n0.b.b.b.b) && _n0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						cw: matchModel.cw + elm$core$String$length(regexMatch.ee),
						K: function () {
							var _n5 = matchModel.K;
							if (_n5.$ === 5) {
	...
	function (matchModel, model, maybeRegexMatch) {
		...
		var toMatch = function (urlTitle) {
			return _Utils_update(
				matchModel,
				{
					cw: matchModel.cw + regexMatchLength,
					K: function () {
						var _n0 = matchModel.K;
						if (_n0.$ === 5) {
							return pablohirafuji$elm_markdown$Markdown$InlineParser$ImageType;
						} else {
							return pablohirafuji$elm_markdown$Markdown$InlineParser$LinkType;
		...
		var refLabel = function (str) {
			return elm$core$String$isEmpty(str) ? matchModel.a4 : str;
		}(
			A2(
				elm$core$Maybe$withDefault,
				matchModel.a4,
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_n0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_n1) {
				var testMatch = _n1;
				return (_Utils_cmp(match.cw, testMatch.b8) > 0) && (_Utils_cmp(match.cw, testMatch.cw) < 0);
			},
			remainMatches);
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_n0) {
	var match = _n0;
	return A2(elm$regex$Regex$contains, pablohirafuji$elm_markdown$Markdown$InlineParser$emailRegex, match.a4) ? elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				K: pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.a4,
						'mailto:' + pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.a4)))
			})) : elm$core$Result$Err(match);
};
	...
	function (model, match, regexMatch) {
		...
		if ((((_n0.b && _n0.b.b) && (!_n0.b.a.$)) && _n0.b.b.b) && _n0.b.b.b.b) {
			...
			switch (_n4.$) {
				...
				case 1:
					var allowedHtmlElements = _n4.a.ck;
					var allowedHtmlAttributes = _n4.a.cj;
	...
	function (model, _n0) {
		...
		if (_n1.$ === 2) {
			...
			return A2(
				...
				elm$core$List$head(
					A3(elm$regex$Regex$findAtMost, 1, pablohirafuji$elm_markdown$Markdown$InlineParser$htmlRegex, match.a4)));
		}
	});
var pablohirafuji$elm_markdown$Markdown$InlineParser$isCloseToken = F2(
	function (htmlModel, token) {
		...
		if ((_n0.$ === 5) && (!_n0.a)) {
			...
			return _Utils_eq(htmlModel.aF, htmlModel_.aF);
		} else {
			return false;
		}
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$isVoidTag = function (htmlModel) {
	return A2(elm$core$List$member, htmlModel.aF, pablohirafuji$elm_markdown$Markdown$InlineParser$voidHtmlTags);
};
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {cw: token.d5 + token.g, f: _List_Nil, b8: token.d5, a4: '', aG: 0, I: 0, K: type_};
	});
var pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_n0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.i, pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.i, pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.a_.eB)) {
		...
		if (!_n0.b) {
			...
			return _Utils_Tuple2(
				A2(
					elm$core$List$filter,
					function (token) {
						return _Utils_cmp(token.d5, match.cw) > -1;
					},
					tokensTail),
				parser);
		}
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$codeToMatch = F3(
	function (closeToken, model, _n20) {
		...
		var updtOpenToken = _Utils_eq(
			...
			openToken,
			{d5: openToken.d5 + 1, g: openToken.g - 1}) : openToken;
		return _Utils_update(
			model,
			{
				f: A2(
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$emphasisToMatch = F4(
	function (closeToken, tokensTail, model, _n15) {
		...
		var updt = (!remainLength) ? {bi: closeToken, aZ: openToken, bw: remainTokens, bC: tokensTail} : ((remainLength > 0) ? {
			bi: closeToken,
			aZ: _Utils_update(
				openToken,
				{d5: openToken.d5 + remainLength, g: closeToken.g}),
			bw: A2(
				elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			bC: A2(
				...
				_Utils_update(
					closeToken,
					{d5: closeToken.d5 + openToken.g, g: -remainLength}),
				tokensTail)
		});
		var match = A6(
			pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			pablohirafuji$elm_markdown$Markdown$InlineParser$EmphasisType(updt.aZ.g),
			updt.aZ,
			updt.bi,
			elm$core$List$reverse(innerTokens));
		return _Utils_Tuple2(
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$linkOrImageTypeToMatch = F4(
	function (closeToken, tokensTail, model, _n1) {
		...
		var remainText = A2(elm$core$String$dropLeft, closeToken.d5 + 1, model.y);
			...
			var process = function (token) {
				...
				if (_n7.$ === 1) {
					return _Utils_update(
						token,
						{
							i: pablohirafuji$elm_markdown$Markdown$InlineParser$LinkOpenToken(false)
						});
				} else {
					return token;
				}
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F6(
	function (model, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.d5 + openToken.g;
		var textEnd = closeToken.d5;
		var start = openToken.d5;
		var end = closeToken.d5 + closeToken.g;
		var match = {
			cw: end,
			f: _List_Nil,
			b8: start,
			...
			case 6:
				...
				return A2(
					...
					function (a) {
						...
						A2(
							elm$core$Basics$composeL,
							A2(pablohirafuji$elm_markdown$Markdown$Block$parseInlines, maybeOptions, model.X),
							function (b) {
...
var pablohirafuji$elm_markdown$Markdown$Block$dropRefString = F2(
	function (rawText, inlineMatch) {
		var strippedText = A2(elm$core$String$dropLeft, inlineMatch.bX, rawText);
...
var pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2(elm$core$Dict$member, linkMatch.ag, refs) ? refs : A3(
			elm$core$Dict$insert,
			linkMatch.ag,
			_Utils_Tuple2(linkMatch.bc, linkMatch.bY),
			refs);
	});
var pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_n0.b && (!_n0.a.$)) && _n0.b.b) && _n0.b.b.b) && _n0.b.b.b.b) && _n0.b.b.b.b.b) && _n0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				ag: rawText,
				bX: elm$core$String$length(regexMatch.ee),
				bY: pablohirafuji$elm_markdown$Markdown$Helpers$returnFirstJust(
					_List_fromArray(
						[maybeTitleSingleQuotes, maybeTitleDoubleQuotes, maybeTitleParenthesis])),
				bc: rawUrl
			};
...
var pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.bc === '') || (linkMatch.ag === '')) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(linkMatch);
		},
		A2(
			elm$core$Maybe$map,
			function (linkMatch) {
...
var author$project$Document$viewMarkdown = function (document) {
	return A2(
		...
		_List_Nil,
		mdgriffith$stylish_elephants$Element$html(
			author$project$MarkdownTools$view(document.w)));
};
...
var jxxcarlson$meenylatex$MeenyLatex$MiniLatex$getRenderedText = function (editRecord) {
	var paragraphs = editRecord.bx;
	var ids = editRecord.av;
	return A3(
		elm$core$List$map2,
		F2(
			function (para, id) {
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$EditRecord = F6(
	function (paragraphs, renderedParagraphs, latexState, idList, newIdsStart, newIdsEnd) {
		return {av: idList, ec: latexState, bs: newIdsEnd, bt: newIdsStart, b1: paragraphs, bx: renderedParagraphs};
	});
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$emptyLatexState = {ad: jxxcarlson$meenylatex$MeenyLatex$LatexState$initialCounters, ct: elm$core$Dict$empty, cv: elm$core$Dict$empty, da: _List_Nil};
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$isEmpty = function (editRecord) {
	return _Utils_eq(editRecord.b1, _List_Nil) && _Utils_eq(editRecord.bx, _List_Nil);
};
var jxxcarlson$meenylatex$MeenyLatex$Accumulator$LatexInfo = F4(
	function (typ, name, options, value) {
		return {eg: name, a_: options, an: typ, P: value};
	});
var jxxcarlson$meenylatex$MeenyLatex$Accumulator$info = function (latexExpression) {
	switch (latexExpression.$) {
		case 6:
			...
			return {eg: name, a_: optArgs, an: 'macro', P: args};
		case 5:
			var name = latexExpression.a;
			var optArgs = latexExpression.b;
			var args = latexExpression.c;
			var body = latexExpression.d;
			return {eg: name, a_: optArgs, an: 'smacro', P: args};
		case 7:
			var name = latexExpression.a;
...
var jxxcarlson$meenylatex$MeenyLatex$StateReducerHelpers$setBibItemXRef = F2(
	function (latexInfo, latexState) {
		var label = jxxcarlson$meenylatex$MeenyLatex$ParserTools$unpackString(latexInfo.P);
		var value = _Utils_eq(latexInfo.a_, _List_Nil) ? label : jxxcarlson$meenylatex$MeenyLatex$ParserTools$unpackString(latexInfo.a_);
...
var jxxcarlson$meenylatex$MeenyLatex$StateReducerHelpers$setDictionaryItemForMacro = F2(
	function (latexInfo, latexState) {
		var value = jxxcarlson$meenylatex$MeenyLatex$ParserTools$unpackString(latexInfo.P);
		return A3(jxxcarlson$meenylatex$MeenyLatex$LatexState$setDictionaryItem, latexInfo.eg, value, latexState);
	});
var jxxcarlson$meenylatex$MeenyLatex$LatexState$getCounter = F2(
	function (name, latexState) {
		var _n0 = A2(elm$core$Dict$get, name, latexState.ad);
		if (!_n0.$) {
			var k = _n0.a;
			return k;
		} else {
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$incrementCounter = F2(
	function (name, latexState) {
		...
		var newCounters = A3(elm$core$Dict$update, name, maybeInc, latexState.ad);
		return _Utils_update(
			latexState,
			{ad: newCounters});
	});
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {cq: col, cW: problem, c3: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.c3, p.cq, p.cW);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{cq: 1, h: _List_Nil, k: 1, c: 0, c3: 1, b: src});
		if (!_n1.$) {
			var value = _n1.b;
			return elm$core$Result$Ok(value);
		} else {
...
var elm$parser$Parser$Advanced$Problem = F4(
	function (row, col, problem, contextStack) {
		return {cq: col, dP: contextStack, cW: problem, c3: row};
	});
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$Problem, s.c3, s.cq, x, s.h));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.c, s.c3, s.cq, s.b);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{cq: newCol, h: s.h, k: s.k, c: newOffset, c3: newRow, b: s.b});
	};
};
...
var elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _n0 = A5(_Parser_findSubString, str, s.c, s.c3, s.cq, s.b);
		var newOffset = _n0.a;
		var newRow = _n0.b;
		var newCol = _n0.c;
		...
		return A3(
			...
			0,
			{cq: newCol, h: s.h, k: s.k, c: adjustedOffset, c3: newRow, b: s.b});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{cq: 1, h: s.h, k: s.k, c: s.c + 1, c3: s.c3 + 1, b: s.b}) : A3(
				elm$parser$Parser$Advanced$Good,
				true,
				0,
				{cq: s.cq + 1, h: s.h, k: s.k, c: newOffset, c3: s.c3, b: s.b}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{cq: col, h: s0.h, k: s0.k, c: offset, c3: row, b: s0.b});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.c3, s.cq, s);
	};
};
...
var elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {cq: col, h: context, k: indent, c: offset, c3: row, b: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3(elm$parser$Parser$Advanced$isSubChar, i.b8, s.c, s.b);
		if (_Utils_eq(firstOffset, -1)) {
			return A2(
				elm$parser$Parser$Advanced$Bad,
				false,
				A2(elm$parser$Parser$Advanced$fromState, s, i.cy));
		} else {
			var s1 = _Utils_eq(firstOffset, -2) ? A7(elm$parser$Parser$Advanced$varHelp, i.cG, s.c + 1, s.c3 + 1, 1, s.b, s.k, s.h) : A7(elm$parser$Parser$Advanced$varHelp, i.cG, firstOffset, s.c3, s.cq + 1, s.b, s.k, s.h);
			var name = A3(elm$core$String$slice, s.c, s1.c, s.b);
			return A2(elm$core$Set$member, name, i.c2) ? A2(
				elm$parser$Parser$Advanced$Bad,
				false,
				A2(elm$parser$Parser$Advanced$fromState, s, i.cy)) : A3(elm$parser$Parser$Advanced$Good, true, name, s1);
		}
	};
};
var elm$parser$Parser$variable = function (i) {
	return elm$parser$Parser$Advanced$variable(
		{cy: elm$parser$Parser$ExpectingVariable, cG: i.cG, c2: i.c2, b8: i.b8});
};
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$updateCounter = F3(
	function (name, value, latexState) {
		...
		var newCounters = A3(elm$core$Dict$update, name, maybeSet, latexState.ad);
		return _Utils_update(
			latexState,
			{ad: newCounters});
	});
...
var jxxcarlson$meenylatex$MeenyLatex$StateReducerHelpers$setSectionCounters = F2(
	function (info, latexState) {
		var argList = A2(
			elm$core$List$map,
			jxxcarlson$meenylatex$MeenyLatex$ParserTools$list2LeadingString,
			A2(elm$core$List$map, jxxcarlson$meenylatex$MeenyLatex$ParserTools$latexList2List, info.P));
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$TocEntry = F3(
	function (name, label, level) {
		return {eb: label, ax: level, eg: name};
	});
...
var jxxcarlson$meenylatex$MeenyLatex$StateReducerHelpers$updateSectionNumber = F2(
	function (info, latexState) {
		...
		return A4(
			...
			jxxcarlson$meenylatex$MeenyLatex$ParserTools$unpackString(info.P),
			label,
			1,
			A3(
				jxxcarlson$meenylatex$MeenyLatex$LatexState$updateCounter,
...
var jxxcarlson$meenylatex$MeenyLatex$Accumulator$latexStateReducer = F2(
	function (parsedParagraph, latexState) {
		...
		return A3(
			...
			_Utils_Tuple2(headElement.an, headElement.eg),
			headElement,
			latexState);
	});
...
var jxxcarlson$meenylatex$MeenyLatex$Paragraph$updateParserRecord = F2(
	function (line, parserRecord) {
		var state2 = A2(jxxcarlson$meenylatex$MeenyLatex$Paragraph$nextState, line, parserRecord.p);
		switch (state2.$) {
			case 0:
				return _Utils_update(
					parserRecord,
					{
						...
						a0: _Utils_ap(
							...
							_List_fromArray(
								[
									A2(jxxcarlson$meenylatex$MeenyLatex$Paragraph$joinLines, parserRecord.L, line)
								])),
						p: state2
					});
			case 1:
				return _Utils_update(
					parserRecord,
					{
						L: A2(jxxcarlson$meenylatex$MeenyLatex$Paragraph$joinLines, parserRecord.L, line),
						p: state2
					});
			case 2:
				var arg = state2.a;
...
var jxxcarlson$meenylatex$MeenyLatex$Paragraph$logicalParagraphParse = function (text) {
	return A3(
		...
		{L: '', a0: _List_Nil, p: jxxcarlson$meenylatex$MeenyLatex$Paragraph$Start},
		A2(elm$core$String$split, '\n', text + '\n'));
};
...
var jxxcarlson$meenylatex$MeenyLatex$LatexDiffer$createEditRecord = F3(
	function (renderer, latexState, text) {
		...
		var latexState2 = _Utils_update(
			...
			{ct: latexState1.ct, cv: latexState1.cv, da: latexState1.da});
		var _n1 = A2(
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$DiffRecord = F4(
	function (commonInitialSegment, commonTerminalSegment, middleSegmentInSource, middleSegmentInTarget) {
		return {bN: commonInitialSegment, bO: commonTerminalSegment, cL: middleSegmentInSource, b$: middleSegmentInTarget};
	});
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$differentialIdList = F3(
	function (seed, diffRecord, editRecord) {
		var nt = elm$core$List$length(diffRecord.b$);
		var ns = elm$core$List$length(diffRecord.cL);
		var it = elm$core$List$length(diffRecord.bO);
		var ii = elm$core$List$length(diffRecord.bN);
		var idListTerminal = A2(elm$core$List$drop, ii + ns, editRecord.av);
		var idListMiddle = A2(
			elm$core$List$map,
			jxxcarlson$meenylatex$MeenyLatex$Differ$prefixer(seed),
			A2(elm$core$List$range, ii + 1, ii + nt));
		var idListInitial = A2(elm$core$List$take, ii, editRecord.av);
		...
		var newIdsEnd = _n0.b;
		return {av: idList, bs: newIdsEnd, bt: newIdsStart};
	});
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$differentialRender = F3(
	function (renderer, diffRecord, editRecord) {
		var middleSegmentRendered = A2(elm$core$List$map, renderer, diffRecord.b$);
		var it = elm$core$List$length(diffRecord.bO);
		var terminalSegmentRendered = A2(jxxcarlson$meenylatex$MeenyLatex$Differ$takeLast, it, editRecord.bx);
		var ii = elm$core$List$length(diffRecord.bN);
		var initialSegmentRendered = A2(elm$core$List$take, ii, editRecord.bx);
		return _Utils_ap(
...
var jxxcarlson$meenylatex$MeenyLatex$Differ$update = F4(
	function (seed, transformer, editRecord, text) {
		...
		var diffRecord = A2(jxxcarlson$meenylatex$MeenyLatex$Differ$diff, editRecord.b1, newParagraphs);
		...
		return A6(jxxcarlson$meenylatex$MeenyLatex$Differ$EditRecord, newParagraphs, newRenderedParagraphs, jxxcarlson$meenylatex$MeenyLatex$LatexState$emptyLatexState, p.av, p.bt, p.bs);
	});
...
var jxxcarlson$meenylatex$MeenyLatex$ListMachine$nextInternalState = function (internalState_) {
	...
	return {
		be: elm$core$List$head(
			A2(elm$core$List$drop, 1, nextInputList_)),
		bK: internalState_.bn,
		bn: internalState_.be,
		aT: nextInputList_
	};
};
var jxxcarlson$meenylatex$MeenyLatex$ListMachine$makeReducer = F3(
	function (computeOutput, input, machineState) {
		var nextInternalState_ = jxxcarlson$meenylatex$MeenyLatex$ListMachine$nextInternalState(machineState.aw);
		var nextInputList = A2(elm$core$List$drop, 1, machineState.aw.aT);
		var newOutput = computeOutput(machineState.aw);
		var outputList = A2(elm$core$List$cons, newOutput, machineState.a$);
		return {aw: nextInternalState_, a$: outputList};
	});
var jxxcarlson$meenylatex$MeenyLatex$ListMachine$initialInternalState = function (inputList) {
	return {
		...
		bn: elm$core$List$head(inputList),
		aT: inputList
	};
};
var jxxcarlson$meenylatex$MeenyLatex$ListMachine$initialMachineState = function (inputList) {
	return {
		aw: jxxcarlson$meenylatex$MeenyLatex$ListMachine$initialInternalState(inputList),
		a$: _List_Nil
	};
};
...
var jxxcarlson$meenylatex$MeenyLatex$ListMachine$run = F2(
	function (reducer, inputList) {
		...
		return elm$core$List$reverse(finalState.a$);
	});
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$getDictionaryItem = F2(
	function (key, latexState) {
		var _n0 = A2(elm$core$Dict$get, key, latexState.cv);
		if (!_n0.$) {
			var value = _n0.a;
			return value;
		} else {
...
var jxxcarlson$meenylatex$MeenyLatex$LatexState$getCrossReference = F2(
	function (label, latexState) {
		var _n0 = A2(elm$core$Dict$get, label, latexState.ct);
		if (!_n0.$) {
			var ref = _n0.a;
			return ref;
		} else {
...
var jxxcarlson$meenylatex$MeenyLatex$Image$ImageAttributes = F3(
	function (width, _float, align) {
		return {dk: align, cz: _float, ce: width};
	});
		...
		return (imageAttrs.cz === 'left') ? A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$Attributes$width(imageAttrs.ce)
				]),
			_List_fromArray(
				[
					A2(
...
var jxxcarlson$meenylatex$MeenyLatex$Render2$renderImageRef = F2(
	function (latexState, args) {
		...
		var attributeString = A3(jxxcarlson$meenylatex$MeenyLatex$Render$renderArg, 2, latexState, args);
		var imageAttrs = jxxcarlson$meenylatex$MeenyLatex$Image$parseImageAttributes(attributeString);
		var theImage = (imageAttrs.cz === 'left') ? A2(
			elm$html$Html$img,
			_List_fromArray(
				[
			...
			_List_Nil) : ((imageAttrs.cz === 'right') ? A2(
			elm$html$Html$img,
			_List_fromArray(
				[
					elm$html$Html$Attributes$src(imageUrl),
			...
			_List_Nil) : ((imageAttrs.dk === 'center') ? A2(
			elm$html$Html$img,
			_List_fromArray(
				[
					elm$html$Html$Attributes$src(imageUrl),
...
var jxxcarlson$meenylatex$MeenyLatex$Render2$makeTocItem = function (tocItem) {
	...
	var id = A2(
		...
		jxxcarlson$meenylatex$MeenyLatex$Render2$sectionPrefix(ti.ax),
		ti.eg);
	var i = tocItem.a;
	var href = 'href=\"#_' + (id + '\"');
	var classProperty = 'class=\"sectionLevel' + (elm$core$String$fromInt(ti.ax) + '\"');
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var jxxcarlson$meenylatex$MeenyLatex$Render2$makeTableOfContents = function (latexState) {
	return A3(
		...
		_List_Nil,
		A2(elm$core$List$indexedMap, elm$core$Tuple$pair, latexState.da));
};
...
var author$project$Document$viewMiniLatex = F2(
	function (texMacros, document) {
		var source = (texMacros === '') ? document.w : A2(author$project$Document$prependMacros, texMacros, document.w);
		var editRecord = A2(jxxcarlson$meenylatex$MeenyLatex$MiniLatex$initializeEditRecord, 0, source);
		return A2(
			mdgriffith$stylish_elephants$Element$column,
			_List_Nil,
			A2(
...
var author$project$Document$documentContentView_ = F3(
	function (debounceCounter, texMacros, document) {
		...
		switch (_n0) {
			...
			case 2:
				return A2(author$project$Document$viewAsciidoc, debounceCounter, document.w);
			case 3:
				return A2(author$project$Document$viewAsciidoc, debounceCounter, document.w);
			default:
...
var author$project$Document$viewChild = function (child) {
	return A2(
		mdgriffith$stylish_elephants$Element$el,
		_List_Nil,
		mdgriffith$stylish_elephants$Element$text(child.J));
};
var author$project$Document$viewChildren = function (document) {
	return A2(
		mdgriffith$stylish_elephants$Element$column,
		_List_fromArray(
			[
		...
		A2(elm$core$List$map, author$project$Document$viewChild, document.bL));
};
var author$project$Document$documentContentView = F3(
	function (debounceCounter, texMacros, document) {
		var _n0 = document.bo;
		if (_n0 === 1) {
			return author$project$Document$viewChildren(document);
		} else {
			return A3(author$project$Document$documentContentView_, debounceCounter, texMacros, document);
		}
	});
var author$project$Document$view = F3(
	function (debounceCounter, texMacros, doc) {
		return {
			w: A3(author$project$Document$documentContentView, debounceCounter, texMacros, doc),
			J: doc.J
		};
	});
		...
		A2(
			...
			author$project$Widget$titleStyleLight,
			{
				eb: A2(
					...
					mdgriffith$stylish_elephants$Element$text(document.b2 + ' :: ')),
				ek: elm$core$Maybe$Just(
					author$project$DocumentView$LoadMasterWithCurrentSelection(document.bv))
			}));
};
var author$project$Widget$charcoal = A3(mdgriffith$stylish_elephants$Element$rgb, 0.4, 0.4, 0.4);
var author$project$DocumentView$titleLineStyle = _List_fromArray(
	[
		A2(mdgriffith$stylish_elephants$Element$paddingXY, 10, 0),
		...
		mdgriffith$stylish_elephants$Element$width(mdgriffith$stylish_elephants$Element$fill),
		mdgriffith$stylish_elephants$Element$height(
		mdgriffith$stylish_elephants$Element$px(36))
	]);
...
var author$project$DocumentView$titleLine = function (document) {
	return (!document.bv) ? A2(
		mdgriffith$stylish_elephants$Element$row,
		author$project$DocumentView$titleLineStyle,
		_List_fromArray(
			[
				A2(
				mdgriffith$stylish_elephants$Element$el,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					windowHeight_,
					counter,
					A3(author$project$Document$view, debounceCounter, texMacros, document))
				]));
	});
...
var author$project$Main$texMacros = function (model) {
	var _n0 = A2(author$project$DocumentDictionary$get, 'texmacros', model.V);
	if (_n0.$ === 1) {
		return '';
	} else {
		var doc = _n0.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(author$project$Main$bodyReaderColumn, model.ab, 7, model),
					...
					A2(
							...
							]),
						{
							eb: A2(
								...
								mdgriffith$stylish_elephants$Element$text('')),
							aY: elm$core$Maybe$Just(author$project$Main$GetContent),
							a2: elm$core$Maybe$Nothing,
							c8: false,
							a4: model.e.w
						}))
	...
	return A2(
		...
		_List_fromArray(
			[
				mdgriffith$stylish_elephants$Element$width(mdgriffith$stylish_elephants$Element$fill),
				mdgriffith$stylish_elephants$Element$height(
				mdgriffith$stylish_elephants$Element$px(model.ab - 70)),
				mdgriffith$stylish_elephants$Element$Background$color(author$project$Widget$white),
				mdgriffith$stylish_elephants$Element$centerX
			]),
		_List_fromArray(
			[
				A2(author$project$Main$bodyLeftColumn, 2, model),
				A3(author$project$Main$bodyEditorColumn, model.ab, 5, model),
				A3(author$project$Main$bodyReaderColumn, model.ab, 5, model)
			]));
};
...
var author$project$Document$wordCount = function (document) {
	return elm$core$List$length(
		elm$core$String$words(document.w));
};
...
var author$project$Main$currentUserName = function (maybeCurrentUser) {
	if (maybeCurrentUser.$ === 1) {
		return 'User: NONE';
	} else {
		var user = maybeCurrentUser.a;
		return 'User: ' + author$project$User$username(user);
	}
};
var author$project$Main$deleteStateIndicator = function (model) {
	var _n0 = model.D;
	if (!_n0) {
		return 'Safety ON';
	} else {
...
var author$project$Main$getAuthorsDocumentsButton_ = F2(
	function (width_, model) {
		var authorname = model.e.bI;
		return A2(
			mdgriffith$stylish_elephants$Element$Input$button,
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Author docs'),
				ek: elm$core$Maybe$Just(
...
var author$project$Main$getAuthorsDocumentsButton = F2(
	function (width_, model) {
		return (model.e.W > 0) ? A2(author$project$Main$getAuthorsDocumentsButton_, width_, model) : mdgriffith$stylish_elephants$Element$none;
	});
...
var author$project$Main$printUrl = function (document) {
	return author$project$Configuration$backend + ('/print/documents' + ('/' + (elm$core$String$fromInt(document.W) + ('?' + author$project$Main$printTypeString(document)))));
};
...
var author$project$Main$printDocument_ = function (model) {
	return author$project$Main$printButton(model.e);
};
...
var author$project$Main$saveCurrentDocumentButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Save'),
				ek: elm$core$Maybe$Just(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$stylish_elephants$Element$el,
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(model.j)),
				A2(
				mdgriffith$stylish_elephants$Element$el,
				_List_fromArray(
					[
				...
				mdgriffith$stylish_elephants$Element$text(
					'id ' + elm$core$String$fromInt(model.e.W))),
				A2(
				...
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(
					author$project$Main$access(model.e))),
				A2(
				mdgriffith$stylish_elephants$Element$el,
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text('Author: ' + model.e.bI)),
				A2(
				mdgriffith$stylish_elephants$Element$el,
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(
					author$project$Main$currentUserName(model.o))),
				A2(
				mdgriffith$stylish_elephants$Element$el,
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(
					elm$core$String$fromInt(
						author$project$Document$wordCount(model.e)) + ' words')),
				A2(
				mdgriffith$stylish_elephants$Element$el,
				_List_Nil,
				mdgriffith$stylish_elephants$Element$text(
					author$project$Main$deleteStateIndicator(model)))
			]));
};
...
var author$project$Main$GetUserDocuments = function (a) {
	return {$: 10, a: a};
};
var author$project$Main$getDocumentMsg = F2(
	function (appMode, docInfo) {
		if (!appMode) {
			return author$project$Main$GetPublicDocuments(docInfo);
		} else {
			return author$project$Main$GetUserDocuments(docInfo);
		}
	});
var author$project$Main$getDocumentsButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Search'),
				ek: elm$core$Maybe$Just(
					A2(author$project$Main$getDocumentMsg, model.u, model.aP))
			});
	});
var author$project$Main$getRandomDocumentsButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Random'),
				ek: elm$core$Maybe$Just(
					author$project$Main$GetPublicDocumentsRawQuery('random=public'))
			});
	});
var author$project$Main$GetToken = {$: 6};
var author$project$Main$getTokenButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Get token'),
				ek: elm$core$Maybe$Just(author$project$Main$GetToken)
			});
	});
var author$project$Main$GoHome = {$: 19};
var author$project$Main$homeButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Home'),
				ek: elm$core$Maybe$Just(author$project$Main$GoHome)
			});
	});
	...
	function (attrs, pass) {
		return A3(
			mdgriffith$stylish_elephants$Element$Input$textHelper,
			{
				...
				E: false,
				K: mdgriffith$stylish_elephants$Element$Input$TextInputNode(
					pass.ez ? 'text' : 'password')
			},
			attrs,
			{eb: pass.eb, aY: pass.aY, a2: pass.a2, a4: pass.a4});
	});
			...
			eb: A2(
				...
				_List_fromArray(
					[
						...
						mdgriffith$stylish_elephants$Element$Font$bold,
						mdgriffith$stylish_elephants$Element$moveDown(10)
					]),
...
var author$project$Main$readerModeButton = F2(
	function (width_, model) {
		return A2(
			mdgriffith$stylish_elephants$Element$Input$button,
			A3(author$project$Main$modeButtonStyle, model.u, 0, width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Read'),
				ek: elm$core$Maybe$Just(
					author$project$Main$ChangeMode(0))
			});
	});
var author$project$Main$GoToStart = {$: 18};
var author$project$Main$startButton = F2(
	function (width_, model) {
		return A2(
			...
			author$project$Widget$buttonStyle(width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Start'),
				ek: elm$core$Maybe$Just(author$project$Main$GoToStart)
			});
	});
...
var author$project$Main$writerModeButton = F2(
	function (width_, model) {
		return A2(
			mdgriffith$stylish_elephants$Element$Input$button,
			A3(author$project$Main$modeButtonStyle, model.u, 1, width_),
			{
				eb: mdgriffith$stylish_elephants$Element$text('Write'),
				ek: elm$core$Maybe$Just(
			...
			[
				...
				_List_fromArray(
					[
						...
						mdgriffith$stylish_elephants$Element$text(
							author$project$Main$appTitle(model.u))),
						A2(
...
var mdgriffith$stylish_elephants$Element$clipY = A2(mdgriffith$stylish_elephants$Internal$Model$Class, mdgriffith$stylish_elephants$Internal$Flag$overflow, mdgriffith$stylish_elephants$Internal$Style$classes.dM);
...
var mdgriffith$stylish_elephants$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{dZ: elm$core$Maybe$Nothing, d1: elm$core$Maybe$Nothing, ef: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$stylish_elephants$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$stylish_elephants$Internal$Style$classes.es, mdgriffith$stylish_elephants$Internal$Style$classes.dt, mdgriffith$stylish_elephants$Internal$Style$classes.eA, mdgriffith$stylish_elephants$Internal$Style$classes.aM, mdgriffith$stylish_elephants$Internal$Style$classes.aq]))),
		...
		A2(
			...
			_List_fromArray(
				[
					mdgriffith$stylish_elephants$Element$width(mdgriffith$stylish_elephants$Element$fill),
					mdgriffith$stylish_elephants$Element$height(
					mdgriffith$stylish_elephants$Element$px(model.ab))
				]),
			_List_fromArray(
				[
...
var author$project$Main$main = elm$browser$Browser$element(
	{d6: author$project$Main$init, eJ: author$project$Main$subscriptions, e1: author$project$Main$update, e3: author$project$Main$view});
